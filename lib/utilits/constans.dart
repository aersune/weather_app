class Constants {
  ...
  static const String WEATHER_DOMAIN_NAME = 'openweathermap.org';
  static const String WEATHER_FORECAST_PATH = '/data/2.5/forecast/daily';
  static const String WEATHER_IMAGES_PATH = '/img/wn/';
  static const String WEATHER_IMAGES_URL = WEATHER_BASE_SCHEME + WEATHER_DOMAIN_NAME + WEATHER_IMAGES_PATH;
}